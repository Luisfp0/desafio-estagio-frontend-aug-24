const StatusPttIcon = () => (
  <span data-icon="status-ptt">
    <svg viewBox="0 0 12 20" height="20" width="12" preserveAspectRatio="xMidYMid meet" version="1.1" x="0px" y="0px" enableBackground="new 0 0 12 20">
      <title>status-ptt</title>
